# TestNodejs Message Extension Bot - `testNodejsMessageExtensionBot`
...
3. Give the bot a handle (ex: `testNodejsMessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://testnodejs.azurewebsites.net/api/messages`
